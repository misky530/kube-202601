...
本项目采用结构化的文档管理方式，所有经验教训和故障排查指南都在 `docs/` 目录下：

- **[文档导航](docs/README.md)** - 查看所有文档
- **[项目结构说明](PROJECT-STRUCTURE.md)** - 了解项目组织方式
- **[集群重装经验](docs/lessons-learned-reinstall.md)** - ⭐ 最重要：使用 `KKZONE=cn`

**如何使用文档**:
1. 遇到问题时，先查看 `docs/troubleshooting/`
2. 学习新功能前，查看对应的 `lessons-learned-` 文档
3. 新的经验教训应及时添加到 `docs/` 目录
